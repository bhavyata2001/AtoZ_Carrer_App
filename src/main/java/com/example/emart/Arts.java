...
public class Arts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        abt_course.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Arts.this,SscCourse.class);
                startActivity(i);
            }
        });
        ...
        sp2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                if (position >= 0 && position < names.length) {
                    ...
                    Toast.makeText(Arts.this, "not exist", Toast.LENGTH_LONG).show();
                }
    ...
    private void getSelectedCategoryData(int catID){
        ...
        if (catID==0)
        {
            Toast.makeText(Arts.this,"Choose a right school in your favourite city for your course",Toast.LENGTH_SHORT).show();
        }else {
...
class ComicBody7{
    ...
    public ComicBody7(String name,int catID){
        this.name = name;
        this.catID = catID;
    }
