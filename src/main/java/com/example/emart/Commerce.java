...
public class Commerce extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        abt_course.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Commerce.this,SscCourse.class);
                startActivity(i);
            }
        });
        ...
        sp2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                if (position >= 0 && position < names.length) {
                    ...
                    Toast.makeText(Commerce.this, "not exist", Toast.LENGTH_LONG).show();
                }
    ...
    private ArrayList<ComicBody> getComicBody() {
        ...
        data.add(new ComicBody("kanya vidhya mandir", 6));
    ...
    private void getSelectedCategoryData(int catID){
        ...
        if (catID==0)
        {
            Toast.makeText(Commerce.this,"Choose a right school in your favourite city for your course",Toast.LENGTH_SHORT).show();
        }else {
...
class ComicBody9{
    ...
    public ComicBody9(String name,int catID){
        this.name = name;
        this.catID = catID;
    }
