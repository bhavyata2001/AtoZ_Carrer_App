...
public class CsCourse extends AppCompatActivity {
    ListView lw1;
    Spinner sp2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        abt_course.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(CsCourse.this,HscCourse.class);
                startActivity(i);
            }
        });
        ...
        sp2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                if (position >= 0 && position < names.length) {
                    ...
                    Toast.makeText(CsCourse.this, "not exist", Toast.LENGTH_LONG).show();
                }
    ...
    private ArrayList<ComicBody> getComicBody() {
        ...
        data.add(new ComicBody("The Institute of Company Secretaries", 1));

        data.add(new ComicBody("Nirma University", 2));
        data.add(new ComicBody("Navkar Institute", 2));

        data.add(new ComicBody("none", 3));

        data.add(new ComicBody("none", 4));

        data.add(new ComicBody("none", 5));
    ...
    private void getSelectedCategoryData(int catID){
        ...
        if (catID==0)
        {
            Toast.makeText(CsCourse.this,"Choose a right school in your favourite city for your course",Toast.LENGTH_SHORT).show();
        }else {
...
class ComicBody21{
    ...
    public ComicBody21(String name,int catID){
        this.name = name;
        this.catID = catID;
    }
