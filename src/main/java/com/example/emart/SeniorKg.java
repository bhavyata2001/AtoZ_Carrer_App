...
public class SeniorKg extends AppCompatActivity {
    ListView lw1;
    Spinner sp2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_senior_kg);
        ...
        abt_course.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(SeniorKg.this,PlayGroupCourse.class);
                startActivity(i);
            }
        });
        ...
        sp2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                if (position >= 0 && position < names.length) {
                    ...
                    Toast.makeText(SeniorKg.this, "not exist", Toast.LENGTH_LONG).show();
                }
    ...
    private void getSelectedCategoryData(int catID){
        ...
        if (catID==0)
        {
            Toast.makeText(SeniorKg.this,"Choose a right school in your favourite city for your course",Toast.LENGTH_SHORT).show();
        }else {
...
class ComicBody3{
    ...
    public ComicBody3(String name,int catID){
        this.name = name;
        this.catID = catID;
    }
